...
import sys
# Resolve this script directory and add the project root to sys.path.
...
# Import quantized model definitions so they register with timm.
try:
    import quant_models
    print("✓ Quantization models loaded and registered to timm")
except ImportError:
    print("⚠ quant_models not found, using timm models only")
